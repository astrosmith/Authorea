\textbf{Formatting}. In addition to simple text you can also add text formatted in \textbf{boldface}, \textit{italic}, \verb|code|, \sout{strike out}, etc. And yes, math too: $E  =  mc^{2}$ or,
\begin{equation}
